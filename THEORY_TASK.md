...
Ниже три небольших задачи. Рекомендуется хотя бы начать делать каждое задание к лекции 28 сентября, чтобы задать вопросы если они будут и обсудить задания.

Формат сдачи - письмо на ```gpucourse@yandex.ru```

 - тема письма как название PR: ```Task02 <Имя Фамилия>```. Имя и фамилию укажите на русском языке
